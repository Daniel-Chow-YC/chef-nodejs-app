...
describe 'node_sample::default' do
  context 'When all attributes are default, on Ubuntu 18.04' do
    ...
    it 'should delete the symlink from default config in sites enabled' do
      expect(chef_run).to delete_link '/etc/nginx/sites-enabled/default'
    end

    it 'runs_apt_update' do
      expect(chef_run).to update_apt_update 'update resources'
    end

    # it 'should create a proxy.conf with a ' do
    #
    # end
